...
class CierreCaja(models.Model):
    ...
    def get_html_context(self):
        ...
        context = {
            ...
            'sistema_efectivo_bs_formatted': format_venezuelan_money(self.Sistema_Efectivo_Bs),
            'sistema_efectivo_usd_formatted': format_venezuelan_money(self.Sistema_Efectivo_USD or 0),
            'sistema_transferencia_formatted': format_venezuelan_money(self.Sistema_Transferencia),
            'sistema_pago_movil_formatted': format_venezuelan_money(self.Sistema_Pago_Movil),
            'sistema_tarjeta_formatted': format_venezuelan_money(self.Sistema_Tarjeta),
            'sistema_punto_venta_formatted': format_venezuelan_money(self.Sistema_Punto_Venta),
            
            # Montos reales formateados
            'real_efectivo_bs_formatted': format_venezuelan_money(self.Real_Efectivo_Bs),
            'real_efectivo_usd_formatted': format_venezuelan_money(self.Real_Efectivo_USD or 0),
            'real_transferencia_formatted': format_venezuelan_money(self.Real_Transferencia),
            'real_pago_movil_formatted': format_venezuelan_money(self.Real_Pago_Movil),
            'real_tarjeta_formatted': format_venezuelan_money(self.Real_Tarjeta),
            'real_punto_venta_formatted': format_venezuelan_money(self.Real_Punto_Venta),
            
            # Diferencias formateadas
            'dif_efectivo_bs_formatted': format_venezuelan_money(diferencias['efectivo_bs']),
            'dif_efectivo_usd_formatted': format_venezuelan_money(diferencias['efectivo_usd']),
            'dif_transferencia_formatted': format_venezuelan_money(diferencias['transferencia']),
            'dif_pago_movil_formatted': format_venezuelan_money(diferencias['pago_movil']),
